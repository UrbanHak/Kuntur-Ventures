              ...
              <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                  ...
                  <InvestmentVertical
                    ...
                    description="AI, Quantum Computing, Advanced Manufacturing, IoT and DePIN For Public Goods. Solving for privacy, inequality, public health and biotechnology."
                    color="bg-industry-red"
                    index={4}
                  />
                  <InvestmentVertical
                    title="Decentralized Telecom & Aerospace"
                    description="Building censorship-resistant systems and decentralized networks of telecommunications. Accelerating open-source and inclusive space exploration while protecting researchers data from third parties or government surveillance."
