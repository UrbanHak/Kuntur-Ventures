              ...
              <div className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-left">
                  ...
                  <InvestmentVertical
                    ...
                    description="Building censorship-resistant systems and decentralized networks of telecommunications. Accelerating open-source and inclusive space exploration while protecting data from third parties or government surveillance."
